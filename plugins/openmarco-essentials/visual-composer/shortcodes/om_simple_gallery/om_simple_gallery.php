...
class OM_Simple_Gallery extends OM_Base_Gallery
{
    ...
    public function init()
    {
        $this->parameters = array(
            ...
            'name' => esc_html__('Simple Gallery Lite', 'theme'),
            'description' => esc_html__('Simple Gallery', 'theme'),
    ...
    public function get_styles()
    {
        ...
        foreach ($shortcodes as $shortcode) {
            ...
            if (!empty($settings['caption_preset']) && !empty($settings['caption_background_image'])) {
                $value = om_get_image($settings['caption_background_image']);
            ...
            if (!empty($settings['caption_preset']) && (!empty($settings['caption_background_size']) || '0' == $settings['caption_background_size'])) {
    ...
    public function init_gallery_item($index, $image_id)
    {
        $this->init_base_gallery_item($index, $image_id, null, null);
